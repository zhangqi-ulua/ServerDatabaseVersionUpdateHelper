CREATE DATABASE  IF NOT EXISTS `mydb` /*!40100 DEFAULT CHARACTER SET eucjpms COLLATE eucjpms_bin */;
USE `mydb`;
...
CREATE TABLE `config_hero` (
  ...
  `rare` int(11) DEFAULT NULL COMMENT '稀有度（11-13）',
...
INSERT INTO `config_hero` VALUES (1,'英雄法师',11,1,1),(2,'英雄战士',11,2,1),(3,'英雄牧师',11,3,1),(4,'英雄勇士',11,4,1);
...
CREATE TABLE `config_hero_equipment` (
  ...
  `heroQuality` int(11) DEFAULT NULL COMMENT '英雄品阶',
  `seq` int(11) DEFAULT NULL COMMENT '装备槽位序号',
  `propId` int(11) DEFAULT NULL COMMENT '装备ID',
  `equipRank` int(11) DEFAULT NULL COMMENT '穿戴等级限制',
  PRIMARY KEY (`id`)
...
INSERT INTO `config_prop` VALUES (100001,1,-1,'小号经验药水','使用增加英雄经验100点',1,'item1',500),(100002,1,-1,'中号经验药水','使用增加英雄经验200点',2,'item1',800),(200001,2,-1,'盾牌','盾牌',1,'item1',800),(200002,2,-1,'弓箭','弓箭',1,'item1',800),(200003,2,-1,'长矛','长矛',1,'item1',800),(200004,2,-1,'护甲','护甲',1,'item1',800),(200005,2,-1,'头盔','头盔',1,'item1',800),(200006,2,-1,'匕首','匕首',1,'item1',800),(200007,2,-1,'禅杖','禅杖',1,'item1',800),(200008,2,-1,'大刀','大刀',1,'item1',800);
...
CREATE TABLE `config_system` (
  ...
  `rewardType1` int(11) DEFAULT NULL COMMENT '类型',
  `rewardId1` int(11) DEFAULT NULL COMMENT 'id',
  `rewardCount1` int(11) DEFAULT NULL COMMENT '数量',
  `rewardType12` int(11) DEFAULT NULL,
  `rewardId2` int(11) DEFAULT NULL,
  `rewardCount2` int(11) DEFAULT NULL,
  PRIMARY KEY (`systemId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='游戏配置表-游戏模块';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `config_system` VALUES (1,'普通关卡','通过普通关卡可以获得一定几率掉落的道具和英雄经验，快来让你的英雄挑战吧！',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'精英关卡','通过精英关卡可以获得一定几率掉落的稀有英雄碎片用于英雄升阶，每天挑战次数有限哦！',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'竞技场','这里是各位英雄彼此切磋较量的场所，有丰富的奖励给予强大的英雄',25,-1,-1,1,100001,10,NULL,NULL,NULL),(4,'商店','在这里你可以花费金币或者钻石来兑换你想要的道具，商店会在每天9点、15点、21点进货新的一批商品哟，欢迎客官前来购买',15,-1,-1,1,100001,5,NULL,NULL,NULL);
...
INSERT INTO `server_config` VALUES (1,'channelId','1','所属渠道（1：苹果官方，2：谷歌官方）','管理员1','2016-10-10 8:00:00'),(2,'serverId','1','服务器编号','管理员1','2016-10-10 8:00:00'),(3,'openTime','2016-11-10 8:00:00','开服时间','管理员1','2016-10-10 8:00:00'),(4,'userConfigNickNameMaxLength','10','玩家昵称最大字数','管理员1','2016-10-10 8:00:00'),(5,'userConfigMaxRank','80','该版本中玩家等级上限','管理员1','2016-10-10 8:00:00');
...
CREATE TABLE `test` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='临时测试';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='玩家信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'张三',100,100),(2,'李四',200,200),(3,'王五',300,300);
...
-- Dump completed on 2016-12-06 15:59:05
